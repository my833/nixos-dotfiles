...
-- local texteditor  = "gnome-text-editor"
...
hl.config({
    dwindle = {
        ...
        -- force_split = 0, -- 0: follows mouse, 1: to left, 2: to right
    },
})
...
hl.bind(secondMod .. " + P", hl.dsp.exec_cmd("hyprpicker"))
...
hl.bind(mainMod .. " + L", function()
  if workspaceIsScrolling() then
    hl.dispatch(hl.dsp.layout("fouce r"))
  else
...
hl.bind(mainMod .. " + H", function()
  if workspaceIsScrolling() then
    hl.dispatch(hl.dsp.layout("fouce l"))
  else
...
hl.bind(secondMod .. "+ CTRL + S", function()
                                       local active_workspace = hl.get_active_workspace().id
                                       hl.dispatch(hl.dsp.window.move({workspace = active_workspace}))
                                 end)

-- hl.bind(secondMod .. "+ CTRL + C", hl.dsp.exec_cmd('grim -g "$(slurp -d)" - | satty -f - --copy-command wl-copy -o "~/Pictures/Screenshots/%Y%m%d_%H%M%S.png"'))
hl.bind(secondMod .. "+ CTRL + C", hl.dsp.exec_cmd('grim -g "$(slurp)" - | swappy -f -'))

hl.bind(secondMod .. " + G", hl.dsp.group.toggle())
...
hl.define_submap("group", function ()
  ...
  hl.bind(mainMod .. " + H", hl.dsp.window.move({ group_aware = true, direction = "left" }))
  hl.bind(mainMod .. " + L", hl.dsp.window.move({ group_aware = true, direction = "right" }))
  hl.bind(mainMod .. " + K", hl.dsp.window.move({ group_aware = true, direction = "up" }))
  hl.bind(mainMod .. " + J", hl.dsp.window.move({ group_aware = true, direction = "down" }))
